...
export default function RankingBoard({ rankings }: RankingBoardProps) {
  ...
  return (
    <div className="absolute bottom-[4cqw] right-[4cqw] z-20 flex w-[34cqw] flex-col gap-[1cqw] rounded-[1.5cqw] bg-white/20 p-[2cqw] shadow-md transition-all">
      <div className="mb-[1cqw] text-center text-[3cqw] font-bold leading-none text-gray-950">
        TOP {RANKING_LIMIT}
      </div>
      {slots.map((entry, index) => (
        ...
        >
          ...
          <span className="flex min-h-[3.45cqw] flex-1 items-center truncate text-[2.25cqw] leading-none text-gray-800">
            {entry?.name ?? ""}
          </span>
